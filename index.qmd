...
Vi ser nå på alle vedtak som ble fattet i går, og betrakter hvor mange dager det gikk fra vi mottok søknaden til vedtaket ble fattet.

- Nøkkeltallene viser antall vedtak som ble fattet totalt, hvor mange av dem som ble behandlet på under et døgn, samt vedtak det har tatt mer enn 90 dager å behandle
...
```{python}
# | class: nokkeltallboks-innhold
value = df["antall_vedtak"].values.sum()
print(f"{value}\nTotalt")
...
```{python}
# | class: nokkeltallboks-innhold
value = df.query("dager_brukt == 0")["antall_vedtak"].values.sum()
print(f"{value}\nUnder en dag")
...
```{python}
# | class: nokkeltallboks-innhold
value = df.query("dager_brukt > 90")["antall_vedtak"].values.sum()
print(f"{value}\nMer enn 90 dager")
...
fig = px.bar(df.query("dager_brukt > 0 & dager_brukt <=90"), x="dager_brukt", y ="antall_vedtak")
