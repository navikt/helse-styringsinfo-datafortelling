...
QUERY = """--sql
SELECT
    COUNT(*) as `innsendt to uker siden`
FROM `styringsinfo_dataset.styringsinfo_sendt_soknad_view`
WHERE DATE(soknad_mottatt, 'Europe/Oslo') >= DATE_SUB(DATE_ADD(DATE(CURRENT_TIMESTAMP(), 'Europe/Oslo'), INTERVAL -EXTRACT(DAYOFWEEK FROM CURRENT_TIMESTAMP()) + 2 DAY), INTERVAL 14 DAY)
AND DATE(soknad_mottatt, 'Europe/Oslo') <= DATE_SUB(DATE_ADD(DATE(CURRENT_TIMESTAMP(), 'Europe/Oslo'), INTERVAL -EXTRACT(DAYOFWEEK FROM CURRENT_TIMESTAMP()) + 8 DAY), INTERVAL 14 DAY)
""" 
...
QUERY = """--sql
    SELECT
    COUNT(*) as `innsendt forrige uke`
FROM `styringsinfo_dataset.styringsinfo_sendt_soknad_view`
WHERE DATE(soknad_mottatt, 'Europe/Oslo') >= DATE_SUB(DATE_ADD(DATE(CURRENT_TIMESTAMP(), 'Europe/Oslo'), INTERVAL -EXTRACT(DAYOFWEEK FROM CURRENT_TIMESTAMP()) + 2 DAY), INTERVAL 7 DAY)
AND DATE(soknad_mottatt, 'Europe/Oslo') <= DATE_SUB(DATE_ADD(DATE(CURRENT_TIMESTAMP(), 'Europe/Oslo'), INTERVAL -EXTRACT(DAYOFWEEK FROM CURRENT_TIMESTAMP()) + 8 DAY), INTERVAL 7 DAY)
""" 
...
QUERY = """--sql
SELECT
    COUNT(*) as `innsendt denne uken`
FROM `styringsinfo_dataset.styringsinfo_sendt_soknad_view`
WHERE DATE(soknad_mottatt, 'Europe/Oslo') >= DATE_ADD(DATE(CURRENT_TIMESTAMP(), 'Europe/Oslo'), INTERVAL -EXTRACT(DAYOFWEEK FROM CURRENT_TIMESTAMP()) + 2 DAY)
""" 
